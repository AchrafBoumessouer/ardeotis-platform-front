...
@Component({
    ...
    standalone:true,
    imports: [MatDialogContent, CommonModule,MatInputModule, ɵInternalFormsSharedModule, MatCheckboxModule, ReactiveFormsModule, MatDialogActions, MatDialogModule, MatFormField, MatSelectModule, MatOptionModule]
})
